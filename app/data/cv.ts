...
export const experience: Role[] = [
  {
    ...
    bullets: [
      ...
      "Directly attracted 3 customers by building a reusable complex workflow-execution visualiser rendering thousands of nodes with real-time stats, offloading heavy computation to Web Workers to keep the UI responsive.",
      "Added automated testing using Cypress and improved CI/CD GitHub Actions, cutting bug reports by 60%.",
      ...
      "Built AI agents and skills letting non-technical teammates safely ship marketing-site changes, reducing engineering requests by 50%. Also built agents and skills that architect and write code to our team standards, standards we set together in my early days at Diagrid.",
  ...
  },
  {
    ...
    body: "Led development and frontend architecture of the Jetstack Secure Platform, an enterprise product built on the open-source cert-manager project, giving platform and security teams visibility, automation, and management of machine identities across Kubernetes and OpenShift.",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      "Built the most important part of their high-traffic property platform, the Property Search and Listing, handling 10,000 visitors a day.",
      ...
      "Helped develop engineering culture, fostered an internal frontend community, and mentored 3 junior engineers.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: "As a founding member at Workvine, developed a series of its IP technologies and led a team of 2 junior designers. At iintegra, implemented, rebuilt, and maintained the Applicant Tracking System (ATS) frontend while leading its design direction and user experience.",
  },
];
